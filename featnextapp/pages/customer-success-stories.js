...
import niketPhuria from '../public/images/testimonials/niket-phuria.jpg';
import deepakSharma from '../public/images/testimonials/deepak-sharm.jpg';
import niketPhuriaID from '../public/images/testimonials/niket-phuria-id.jpg';
...
import quotationImg from '../public/images/quotation-mark.svg';
...
const CustomerSuccessStories = () => {
    ...
    return (
        <>
                ...
                <Carousel itemsToShow={1}>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="iris-video">
                                    <div dataurl="https://tube.featsystems.com/video/viacom18-sucess-story" onClick={(toggleClass, event => setActive(event.target.getAttribute('dataurl')))}>
                                        <Image className="thumbStyle img-fluid" src={niketPhuria} align="Nikhet Phuria" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="iris-video">
                                    <div onClick={(toggleClass, event => setActive(event.target.getAttribute('dataurl')))} dataurl="https://tube.featsystems.com/video/kotak-mahindra-bank-limited-success-story">
                                        <Image className="thumbStyle img-fluid" src={deepakSharma} align="FIBO Video" />
                                    </div>
            ...
            <section id="Read" className="tech-part-sections mb-20">
                <Carousel itemsToShow={1}>
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="crousel">
                                    <div className="main_grid">
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12">
                                                <Image className="qt_mark" alt="Quotation Mark" src={quotationImg} />
                ...
                <div className="modal-section video-modal">
                    <div className="modal-box">
                        <div className="modal-body">
                            ...
                            <div onClick={toggleClass} className="close-md"><Image src={closeImg} /></div>
                        </div>
                    </div>
                </div>
            </section>
