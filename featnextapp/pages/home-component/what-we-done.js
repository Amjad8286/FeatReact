...
import customerIcon from '../../public/images/home/customer-icon.png';
import industryIcon from '../../public/images/home/industry-icon.png';
import processIcon from '../../public/images/home/process-icon.png';
import efficencyIcon from '../../public/images/home/efficency-icon.png';
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="cl-bx flex align-center">
                                <div>
                                    <Image src={customerIcon} alt="customer servered" />
                                </div>
                                <div className="s-txt">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="cl-bx flex align-center">
                                <div>
                                    <Image src={industryIcon} alt="customer servered" />
                                </div>
                                <div className="s-txt">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="cl-bx flex align-center">
                                <div>
                                    <Image src={processIcon} alt="customer servered" />
                                </div>
                                <div className="s-txt">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="cl-bx flex align-center">
                                <div>
                                    <Image src={efficencyIcon} alt="customer servered" />
                                </div>
                                <div className="s-txt">
