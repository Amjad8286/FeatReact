...
import irisImg from '../public/images/inner-page/iris-img.png';
                ...
                <div className="container">
                    <div className="row align-center column-reverse">
                        <div className="col-lg-8">
                            ...
                            <Link href="/" className="btn btn-dark">Fee Trial</Link>
                            <Link href="/" className="btn btn-primary">Pricing</Link>
                            <Link href="/" className="btn btn-border">Process Definitions</Link>
                        </div> */}
                        </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <ul className="breadcrumb">
                                ...
                                <li><Link href="/pigeoniCQRS"><a>IRIS</a></Link></li>
                                <li>Pricing</li>
                            </ul>
                        </div>
                    </div>
            ...
            <section className={`data-modal ${isBasicActive ? "active" : ""}`}>
                <div className="modal-section">
                    <div className="modal-body">
                        ...
                        <div onClick={handleBasicPrice} className="close-md"><Image src={closeImg} /></div>
            ...
            <section className={`data-modal ${isStdActive ? "active" : ""}`}>
                <div className="modal-section">
                    <div className="modal-body">
                        ...
                        <div onClick={handleStdPrice} className="close-md"><Image src={closeImg} /></div>
            ...
            <section className={`data-modal ${isProActive ? "active" : ""}`}>
                <div className="modal-section">
                    <div className="modal-body">
                        ...
                        <div onClick={handleProPrice} className="close-md"><Image src={closeImg} /></div>
            ...
            <section className={`data-modal ${isEntActive ? "active" : ""}`}>
                <div className="modal-section">
                    <div className="modal-body">
                        ...
                        <div onClick={handleEntPrice} className="close-md"><Image src={closeImg} /></div>
