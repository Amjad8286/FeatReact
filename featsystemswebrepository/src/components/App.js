...
import RpaFinanceAndBanking from '../components/finance-and-banking/rpa-finance-and-banking';

import ChequeProcessing from '../components/finance-and-banking/case-studies/cheque-processing-automation';
import NPAReportAutomation from '../components/finance-and-banking/case-studies/potential-npa-report-automation';
import InvoiceProcessingAutomation from '../components/finance-and-banking/case-studies/invoice-processing-automation';
import BankSettlementAutomation from '../components/finance-and-banking/case-studies/bank-settlement-reconciliation-automation';
import UPIandIMPSAutomation from '../components/finance-and-banking/case-studies/upi-imps-complaints-automation';
import ATMComplaintsAutomation from '../components/finance-and-banking/case-studies/atm-complaints-automation';
import EMIForeclosureAutomation from '../components/finance-and-banking/case-studies/emi-foreclosure';
import CMSComplaintsDownload from '../components/finance-and-banking/case-studies/cms-complaints-download';
import PreauditPreparationAutomation from '../components/finance-and-banking/case-studies/pre-audit-preparation-automation';
import ATMReconciliationAutomation from '../components/finance-and-banking/case-studies/atm-reconciliation-automation';
import NonMaintenanceChargeReversalProcess from '../components/finance-and-banking/case-studies/non-maintenance-charge-reversal-process';
import CPGRAMSComplaintsAutomation from '../components/finance-and-banking/case-studies/cpgrams-complaints-automation';
import CMSComplaintsUploadAutomation from '../components/finance-and-banking/case-studies/cms-complaints-upload-automation';
import AccountOpeningProcess from '../components/finance-and-banking/case-studies/account-opening-process';
import CustomerSupportAutomation from '../components/finance-and-banking/case-studies/customer-support-automation';
import CKYCUploadAutomation from '../components/finance-and-banking/case-studies/ckyc-upload-automation';
import OTSRepaymentProcessAutomation from '../components/finance-and-banking/case-studies/ots-repayment-process-automation';
import CRMprocessAutomation from '../components/finance-and-banking/case-studies/crm-process-automation';
import DuplicateStatementAutomation from '../components/finance-and-banking/case-studies/duplicate-credit-card-statement-automation';
import NeftRtgsReportsAutomation from '../components/finance-and-banking/case-studies/neft-rtgs-reports-automation';
import CustomerServicesProcess from '../components/finance-and-banking/solutions/customer-service';
import KYCprocess from '../components/finance-and-banking/solutions/ekyc-process';
import ReportAutomationProcess from '../components/finance-and-banking/solutions/report-automation';
import AccountClosureProcess from '../components/finance-and-banking/solutions/account-closure-process';
import MFreconciliationProcess from '../components/finance-and-banking/solutions/mf-reconciliation-process';
import ComplianceProcess from '../components/finance-and-banking/solutions/compliance';
import AccountPayableProcess from '../components/finance-and-banking/solutions/accounts-payable';
import GeneralLedgerProcess from '../components/finance-and-banking/solutions/general-ledger';
import CreditCardProcess from '../components/finance-and-banking/solutions/credit-card-processing';
import MortgageProcess from '../components/finance-and-banking/solutions/mortgage-processing';
import FraudDetectionProcess from '../components/finance-and-banking/solutions/fraud-detection';
import RpaForInsurance from '../components/rpa-Insurance/rpa-insurance';
import InsuranceClaimProcess from '../components/rpa-Insurance/case-studies/insurance-claim-process';
import TPAInsuranceCorporateCredit from '../components/rpa-Insurance/case-studies/tpa-insurance-and-corporate-credit-business';
import UnderwritingProcessInsurance from '../components/rpa-Insurance/solutions/new-business-and-underwriting';
import ClaimingprocessInsurance from '../components/rpa-Insurance/solutions/claims-processing';
import BusinessandProcessAnalytics from '../components/rpa-Insurance/solutions/business-and-process-analytics';
import ManualDataEntry from '../components/rpa-Insurance/solutions/manual-data-entry-process';
import UsageLegacyApplication from '../components/rpa-Insurance/solutions/usage-of-legacy-applications';
import RegulatoryCompliance from '../components/rpa-Insurance/solutions/regulatory-compliance';
import PolicyCancellationProcess from '../components/rpa-Insurance/solutions/policy-cancellation';
import RpaForRetail from '../components/rpa-retail/rpa-retail';
import WaybillReconciliationAutomation from '../components/rpa-retail/case-studies/invoice-eway-bill-reconciliation-automation';
import InvoicePostingProcessAutomation from '../components/rpa-retail/case-studies/invoice-posting-process-automation';
import MasterDataManagement from '../components/rpa-retail/solutions/master-data-management';
import GoodReceiptMatching from '../components/rpa-retail/solutions/invoice-to-good-receipt-matching';
import ReturnProcessing from '../components/rpa-retail/solutions/return-processing';
import WorkflowManagement from '../components/rpa-retail/solutions/workflow-management';
import CustomerSupportManagement from '../components/rpa-retail/solutions/customer-support-management';
import ERPManagement from '../components/rpa-retail/solutions/erp-management';
import AccountingAndFinance from '../components/rpa-retail/solutions/accounting-and-finance';
import DemandSupplyPlanning from '../components/rpa-retail/solutions/demand-and-supply-planning';
import MarketingBehaviorAnalysis from '../components/rpa-retail/solutions/marketing-and-consumer-behavior-analysis';
import LogisticsSupplyChainManagement from '../components/rpa-retail/solutions/logistics-and-supply-chain-management';
import RpaForManufacturing from '../components/rpa-manufacturing/rpa-manufacturing';
import RpaForHealthcare from '../components/rpa-healthcare/rpa-healthcare';
import PatientRegistration from '../components/rpa-healthcare/solutions/patient-registration';
import ScheduleAppointment from '../components/rpa-healthcare/solutions/schedule-appointment';
import HealthcareWorkflowManagement from '../components/rpa-healthcare/solutions/healthcare-workflow-management';
import DischargeInstructionProcess from '../components/rpa-healthcare/solutions/discharge-instructions';
import BetterCareCycle from '../components/rpa-healthcare/solutions/better-care-cycle';
import BetterMediclaimProcess from '../components/rpa-healthcare/solutions/mediclaim';
import AuditProcedures from '../components/rpa-healthcare/solutions/audit-procedures';
import RPAforMedia from '../components/rpa-media/rpa-media';
import VendorContractRenewal from '../components/rpa-media/case-studies/vendor-contract-renewal-automation';
import AircheckProcessAutomation from '../components/rpa-media/case-studies/aircheck-process-automation';
import ToProcessAutomation from '../components/rpa-media/case-studies/to-process-automation';
import OrderProcessing from '../components/rpa-media/solutions/order-processing';
import DailyReportProcess from '../components/rpa-media/solutions/daily-report-process';
import RpaForAirline from '../components/rpa-airline/rpa-airline';
import JPRefundForUBR from '../components/rpa-airline/case-studies/jp-refund-for-ubr';
import AmexCobrandAutomation from '../components/rpa-airline/case-studies/amex-cobrand-member-enrollment-automation';
import RpaForLogistics from '../components/rpa-logistics/rpa-logistics';
import CashApplicationAutomation from '../components/rpa-logistics/case-studies/cash-application';
import RpaForHr from '../components/rpa-human-resource/rpa-human-resource';
import OnlineJobPosting from '../components/rpa-human-resource/case-studies/online-job-posting';
import CandidateSourcingAutomation from '../components/rpa-human-resource/case-studies/candidate-sourcing-and-screening';
import PostingEmployeeAutomation from '../components/rpa-human-resource/case-studies/posting-employee-training-details';
import BackgroundVerificationAutomation from '../components/rpa-human-resource/case-studies/employee-background-verification';
import ItInfrastructure from '../components/it-infrastructure/it-infrastructure';
import PasswordResetAutomation from '../components/it-infrastructure/case-studies/password-reset-in-active-directory-automation';
import NetworkProcessingAutomation from '../components/it-infrastructure/case-studies/network-outage-ticket-processing-automation';
import RouterConfigurationAutomation from '../components/it-infrastructure/case-studies/cisco-router-configuration-automation';
import EmployeeAccessAutomation from '../components/it-infrastructure/case-studies/employee-access-creation-automation';
import MemoryUtilizationAutomation from '../components/it-infrastructure/case-studies/memory-utilization-check-automation';
import VirtualMachineAutomation from '../components/it-infrastructure/case-studies/virtual-machine-creation-automation';
import IOSServerRestartAutomation from '../components/it-infrastructure/case-studies/ios-server-restart-automation';
import SwitchConfigurationAutomation from '../components/it-infrastructure/case-studies/cisco-switch-configuration-migration-automation';
import CUCMAutomation from '../components/it-infrastructure/case-studies/cisco-unified-call-manager-installation';
import PhysicaltoVirtualAutomation from '../components/it-infrastructure/case-studies/physical-to-virtual-machine-creation-automation';
import PrintingConfiguration from '../components/it-infrastructure/solutions/printing-configuration';
import ChangePasswordAutomation from '../components/it-infrastructure/solutions/change-password';
import EmailMigrationAutomation from '../components/it-infrastructure/solutions/email-migration';
import NetworkFileSharingAutomation from '../components/it-infrastructure/solutions/network-file-sharing';
import ShrinkFileinSQLServer from '../components/it-infrastructure/solutions/shrink-file-sql-server';
import CpuOptimizationAutomation from '../components/it-infrastructure/solutions/cpu-optimization';
import AutomationSetuProcessDefinition from '../components/automation-setu-process-definition';
import PigeonProcessDefinitions from '../components/pigeon-process-definitions';
import PigeoniVIPS from '../components/pigeoniVIPS';
import FeatBlog from '../components/blog'
