                    ...
                    <div className="social-pry">
                        <div className="operations-txt">
                            ...
                            <div className="social-icon">
                                <ul>
                                    <li><a href="https://www.linkedin.com/company/featsystems" title="LinkedIn" target="_blank"><img alt="LinkedIn profile icon" src={linkedin}/></a></li>
                                    <li><a href="https://www.youtube.com/channel/UCWe9bAbK9k1KQYYStfdFctQ" title="Youtube" target="_blank"><img alt="Featsystems YouTube profile icon" src={YouTube} /></a></li>
                                    <li><a href="https://tube.featsystems.com/" title="Feat Tube" target="_blank"><img alt="Featsystems Feat tube video icon" src={Feattube} /></a></li>
                                    <li><a href="https://twitter.com/FeatSystems" title="Twitter" target="_blank"><img  alt="Featsystems twitter page" src={twitter} /></a></li>
                                    <li><a href="https://www.facebook.com/featsystems" title="Facebook" target="_blank"><img alt="Facebook page of featsystems" src={facebook} /></a></li>
