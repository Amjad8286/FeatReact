...
import beneimg1 from '../images/inner-page/bene-1.jpg'
import beneimg2 from '../images/inner-page/bene-2.jpg'
import beneimg3 from '../images/inner-page/bene-3.jpg'
import beneimg4 from '../images/inner-page/bene-4.jpg'
import beneimg5 from '../images/inner-page/bene-5.jpg'
import beneimg6 from '../images/inner-page/bene-6.jpg'
import beneimg7 from '../images/inner-page/bene-7.jpg'

import engImg from '../images/inner-page/engage-img.jpg'
...
import offerimg5 from '../images/inner-page/offer-5.jpg'
import offerimg6 from '../images/inner-page/offer-6.jpg'
                ...
                <div className="modal-section">
                    <div className="modal-box">
                        <div className="modal-body">
                            ...
                            <PricingForm />
                            <div onClick={bookBot} className="close-md"><img src={closeImg} /></div>
                        </div>
                    </div>
                </div>
            </section>
            <section className={`data-modal ${isSubsActive ? "active" : ""}`}>
                <div className="modal-section">
                    <div className="modal-body">
                        ...
                        <div onClick={subscriptionCal} className="close-md"><img src={closeImg} /></div>
