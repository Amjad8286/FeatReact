...
import indimg9 from '../images/inner-page/industries/ind-9.jpg'
import indimg10 from '../images/inner-page/industries/ind-10.jpg'
                    ...
                    <div className="row align-center column-reverse">
                        <div className="col-lg-12">
                            ...
                            <div className="gt-button mt-40">
                                <Link to="/what-is-rpa" className="btn btn-dark">Know more</Link>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <Link to="/rpa-human-resource" className="card-box-full">
                                <img src={indimg9} />
                            </Link>
                        </div>
                        <div className="col-lg-4">
                            <Link to="/it-infrastructure" className="card-box-full">
                                <img src={indimg10} />
                            </Link>
                        </div>
